...
public class FullscreenVideoActivity extends Activity implements SurfaceHolder.Callback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            currentTime = savedInstanceState.getLong("key");
        }
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        if (currentTime!=0) {
            mediaPlayer.seekTo((int) (currentTime + System.currentTimeMillis()));
        }
        mediaPlayer.start();
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putLong("key", (long) mediaPlayer.getCurrentPosition());
    }
